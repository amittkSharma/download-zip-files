...
export class Download {
  ...
  downloadFileFromUrl = (downloadUrl: string, responseType: ResponseType, fileName: string) => {
    ...
    axios({
      ...
      const responseData =
        responseType === 'application/json' ? JSON.stringify(response.data, null, 2) : response.data
